...
export const metadata: Metadata = {
  title: "PVC-Classic Plantation Shutters | VERA",
  description: "Premium PVC plantation shutters with 20-year warranty. Refined surface finish, enhanced durability. NZ wholesale trade supply.",
};

export default function PvcPremiumPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      <nav className="text-sm text-stone mb-8">
        <Link href="/products" className="hover:text-green">Products</Link>
        <span className="mx-2">/</span>
        <span className="text-ink font-medium">PVC-Classic Shutters</span>
      </nav>

      <div className="bg-white border border-border p-8 md:p-10">
        <span className="text-xs uppercase tracking-[0.15em] text-stone font-medium">VERA Classic</span>
        <h1 className="text-3xl md:text-4xl font-bold text-ink mt-1">PVC-Classic Plantation Shutters</h1>
        <p className="mt-2 text-stone italic">Upgraded PVC with a refined finish.</p>
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-8">
          <div>
            <ZoomableImage
              ...
              alt="VERA Classic PVC Premium Plantation Shutter — White finish"
              className="w-full rounded-sm mb-6 object-cover"
              style={{ aspectRatio: "4/3" }}
            />
            <p className="text-stone text-sm leading-relaxed">
              The PVC-Classic represents a meaningful upgrade from the entry-level Eco series. A higher-grade PVC
              compound delivers a noticeably smoother surface finish, improved colour stability, and greater
              resistance to heat and humidity. The 20-year warranty reflects the step up in durability.
            </p>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ["Series", "VERA Classic"],
                  ["Material", "Premium-grade PVC compound"],
                  ["Warranty", "20 years"],
                  ...
                  ["Moisture resistant", "Yes — suitable for bathrooms and kitchens"],
          ...
          <div className="bg-warm border border-border p-6">
            ...
            <ul className="space-y-3">
              {["Family homes and apartments", "Bathrooms and kitchens", "Coastal and high-humidity areas", "Properties requiring long warranties"].map((item) => (
